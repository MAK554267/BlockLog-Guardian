...
print("="*60)
print("  DEPLOYING SMART CONTRACTS (FIXED)")
print("="*60)
print()
...
# Check if mining is active using a different method
try:
    is_mining = w3.eth.mining
except AttributeError:
    # If mining attribute doesn't exist, check by seeing if block number increases
    is_mining = "unknown (check block number)"
print(f"   Mining: {is_mining}")
print()
